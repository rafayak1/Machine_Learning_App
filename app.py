...
def main():
    ...
    if choice == 'EDA':
        ...
        st.markdown("This is a Streamlit app to perform data analysis and model building")
        st.markdown("**Created by:** [Abdul Rafay Ahmed Khan](https://rafaykhan-portfolio.netlify.app)")
